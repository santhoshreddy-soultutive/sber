(function () {
  ...
  (self["webpackChunkangular"] = self["webpackChunkangular"] || []).push([["main"], {
    ...
    5041: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _C_Users_PATTERNS0004_Downloads_ngx_hide_on_scroll_bdccca_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! gsap/ScrollTrigger */
      8093);
      /* harmony import */


      var _files_accountstatement_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./_files/accountstatement.json */
      5179);
      /* harmony import */


      var _files_merchantdetail_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./_files/merchantdetail.json */
      8976);
      /* harmony import */


      var _files_transactioncodedetail_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./_files/transactioncodedetail.json */
      5103);
      ...
      var MAX_VERTICAL_SCROLL = 0.1847290640394089;

      var toVw = function toVw(value) {
        return value / 375 * window.innerWidth;
      };

      var toVh = function toVh(value) {
        return value / 812 * window.innerHeight;
      };

      var OVERVIEW_WIDTH = toVw(35);
      var CARD_MARGIN = toVw(20);
      var CARD_WIDTH = toVw(214);
      var CARD_DETAIL_WIDTH = toVw(375);
      var NEWACCOUNT_WIDTH = toVw(64);
      var CARD_MOVEMENT_WIDTH = Math.floor(CARD_MARGIN + CARD_WIDTH);
      var CARD_SELECTION_ANIMATION_DURATION = CARD_MOVEMENT_WIDTH / 1000.0;

      var _AppComponent = /*#__PURE__*/function () {
        function AppComponent(renderer2) {
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            ...
            for (var j = 0; j < _files_accountstatement_json__WEBPACK_IMPORTED_MODULE_2__.length; j++) {
              ...
              if (_files_accountstatement_json__WEBPACK_IMPORTED_MODULE_2__[j].merchantId && _files_accountstatement_json__WEBPACK_IMPORTED_MODULE_2__[j].merchantId != undefined && _files_accountstatement_json__WEBPACK_IMPORTED_MODULE_2__[j].merchantId != " ") {
                var merchantId = null;
                merchantId = _files_merchantdetail_json__WEBPACK_IMPORTED_MODULE_3__.find(function (obj) {
                ...
                var transactionCodeId = null;
                transactionCodeId = _files_transactioncodedetail_json__WEBPACK_IMPORTED_MODULE_4__.find(function (obj) {
          ...
          key: "setupDockAnimation",
          value: function setupDockAnimation() {
            var _this = this;

            var animationDockDuration = Math.floor(MAX_VERTICAL_SCROLL * window.innerHeight) / 1000.0;
            ...
            this.dockActiveCardTimeline = gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.timeline({
              scrollTrigger: {
                ...
                onEnterBack: function onEnterBack(_ref2) {
            ...
            this.dockActiveCardTimeline.eventCallback("onComplete", function () {
              console.log("dockActiveCardTimeline", "onComplete");
            });
            this.dockActiveCardTimeline.eventCallback("onReverseComplete", function () {
              console.log("dockActiveCardTimeline", "onReverseComplete");

              _this.dockActiveCardTimeline.reversed(false).pause().seek(0);
            });
          ...
          key: "dockScrollHandler",
          value: function dockScrollHandler($event) {
            var progress = this.getScrollerProgress();
            this.seekDockAnimation(progress);
            console.log("Scroll", window.scrollY, window.innerHeight, window.innerWidth, progress);
          }
        }, {
          key: "getScrollerProgress",
          value: function getScrollerProgress() {
            var position = window.scrollY / window.innerHeight;
            var progress = position / MAX_VERTICAL_SCROLL * 100;
          ...
          key: "scrollHandler",
          value: function scrollHandler(progress) {
            this.seekDockAnimation(progress);
          }
        }, {
          key: "scheduleDockReverse",
          value: function scheduleDockReverse() {}
        }, {
          key: "scheduleDockCompletion",
          value: function scheduleDockCompletion() {}
        }, {
          key: "seekDockAnimation",
          value: function seekDockAnimation(progress) {
            var animationDuration = Math.floor(MAX_VERTICAL_SCROLL * window.innerHeight * 3) / 1000.0;
            var seekTime = animationDuration * (progress / 100);
            console.log("Seek", seekTime, animationDuration);
            var animeInstances = [];
            animeInstances.push(this.dockActiveCardTimeline);
            animeInstances.forEach(function (item) {
              if (item) {
          ...
          key: "teardownDockAnimation",
          value: function teardownDockAnimation() {
          ...
          key: "teardownCarouselCardChangeAnimation",
          value: function teardownCarouselCardChangeAnimation() {
          ...
          key: "setupCarouselCardChangeAnimation",
          value: function setupCarouselCardChangeAnimation() {
            var _this2 = this;
            ...
            this.nextAsCurrentCardTimeline.eventCallback("onComplete", function () {
              console.log("activeToFromInactiveTimeline", "onComplete");
              setTimeout(function () {
                _this2.teardownCarouselCardChangeAnimation();

                _this2.setupCarouselCardChangeAnimation();
              });
            });
            this.nextAsCurrentCardTimeline.eventCallback("onReverseComplete", function () {
              console.log("onReverseComplete ", "activeToFromInactiveTimeline");

              _this2.nextAsCurrentCardTimeline.reversed(false).pause().seek(0);
            });
            ...
            this.previousAsCurrentCardTimeline.eventCallback("onComplete", function () {
              console.log("activeToFromInactiveTimeline", "onComplete");
              setTimeout(function () {
                _this2.teardownCarouselCardChangeAnimation();
            ...
            this.previousAsCurrentCardTimeline.eventCallback("onReverseComplete", function () {
              console.log("onReverseComplete ", "activeToFromInactiveTimeline");

              _this2.previousAsCurrentCardTimeline.reversed(false).pause().seek(0);
            });
          ...
          key: "setupCarouselAnimation",
          value: function setupCarouselAnimation() {
            var _this3 = this;

            this.cardSelectorCarouselNextAsCurrentAIs = new Array();
            this.cardSelectorCarouselPreviousAsCurrentAIs = new Array();
            var nextAsCurrentPosition = 0;
            var previousAsCurrentPosition = 0;
            var nextAsCurrentDetailPosition = 0;
            var previousAsCurrentDetailPosition = 0;

            var _loop = function _loop(cardIndex) {
              var translatePositionNextAsCurrent = void 0;
              var translatePositionPreviousAsCurrent = void 0;
              var translatePositionDetailNextAsCurrent = void 0;
              var translatePositionDetailPreviousAsCurrent = void 0;
              ...
              if (cardIndex == _this3.cards.length - 1) {
              ...
              var cardSelectorCarouselNextAsCurrentAI = gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.timeline({
                paused: true,
                duration: CARD_SELECTION_ANIMATION_DURATION,
                ease: "none"
              });
              cardSelectorCarouselNextAsCurrentAI.eventCallback("onComplete", function () {
                console.log("onComplete ", cardIndex);
                _this3.lastSwipedIndex = -1;
                _this3.selectedCardIndex = cardIndex;
                document.body.style.overflowY = "scroll";
                setTimeout(function () {
                  _this3.teardownDockAnimation();

                  _this3.setupDockAnimation();

                  _this3.teardownCarouselCardChangeAnimation();

                  _this3.setupCarouselCardChangeAnimation();
                });

                if (cardIndex > 0) {
                  _this3.cardSelectorCarouselPreviousAsCurrentAIs[cardIndex - 1].pause().seek(0);
                }
              });
              cardSelectorCarouselNextAsCurrentAI.eventCallback("onReverseComplete", function () {
              ...
              cardSelectorCarouselNextAsCurrentAI.fromTo(".card-selector", {
                x: translatePositionNextAsCurrent[0]
              }, {
                x: translatePositionNextAsCurrent[1]
              }, 0);
              cardSelectorCarouselNextAsCurrentAI.fromTo(".card-details", {
                x: translatePositionDetailNextAsCurrent[0]
              }, {
                x: translatePositionDetailNextAsCurrent[1]
              }, 0);

              _this3.cardSelectorCarouselNextAsCurrentAIs.push(cardSelectorCarouselNextAsCurrentAI);

              var cardSelectorCarouselPreviousAsCurrentAI = gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.timeline({
                paused: true,
                duration: CARD_SELECTION_ANIMATION_DURATION,
                ease: "none"
              });
              cardSelectorCarouselPreviousAsCurrentAI.eventCallback("onComplete", function () {
                console.log("onComplete ", cardIndex);
                _this3.lastSwipedIndex = -1;
                _this3.selectedCardIndex = cardIndex;
                document.body.style.overflowY = "scroll";
                ...
                if (cardIndex < _this3.cards.length - 1) {
                  _this3.cardSelectorCarouselNextAsCurrentAIs[cardIndex + 1].pause().seek(0);
                }
              });
              cardSelectorCarouselPreviousAsCurrentAI.eventCallback("onReverseComplete", function () {
                console.log("onReverseComplete ", cardIndex);
                _this3.lastSwipedIndex = -1;
                document.body.style.overflowY = "scroll";
              ...
              cardSelectorCarouselPreviousAsCurrentAI.fromTo(".card-selector", {
                x: translatePositionPreviousAsCurrent[0]
              }, {
                x: translatePositionPreviousAsCurrent[1]
              }, 0);
              cardSelectorCarouselPreviousAsCurrentAI.fromTo(".card-details", {
                x: translatePositionDetailPreviousAsCurrent[0]
              }, {
                x: translatePositionDetailPreviousAsCurrent[1]
              }, 0);

              _this3.cardSelectorCarouselPreviousAsCurrentAIs.push(cardSelectorCarouselPreviousAsCurrentAI);

              setTimeout(function () {
                _this3.cardSelector.nativeElement.style.transform = "translateX(0)";
                _this3.cardDetails.nativeElement.style.transform = "translateX(0)";
              });
            };
          ...
          key: "teardownCarouselAnimation",
          value: function teardownCarouselAnimation() {
            this.teardownCarouselCardChangeAnimation();
            this.cardSelectorCarouselPreviousAsCurrentAIs.forEach(function (item) {
              if (item) {
                item.kill();
                item = null;
              }
            });
            this.cardSelectorCarouselNextAsCurrentAIs.forEach(function (item) {
              if (item) {
                item.kill();
                item = null;
              }
          ...
          key: "seekNextAsCurrentCarouselAnimation",
          value: function seekNextAsCurrentCarouselAnimation(index, progress) {
            var seekTime = CARD_SELECTION_ANIMATION_DURATION * (progress / 100);
          ...
          key: "seekPreviousAsCurrentCarouselAnimation",
          value: function seekPreviousAsCurrentCarouselAnimation(index, progress) {
            var seekTime = CARD_SELECTION_ANIMATION_DURATION * (progress / 100);
            console.log("Seek", seekTime);
            var animeInstances = [];
          ...
          key: "updateCarouselOffsetProgress",
          value: function updateCarouselOffsetProgress(anim) {}
        }, {
          key: "getCaraouselSwipeProgress",
          value: function getCaraouselSwipeProgress(index) {
            var OVERVIEW_WIDTH = toVw(35);
            var CARD_MARGIN = toVw(20);
            var CARD_WIDTH = toVw(214);
            var NEWACCOUNT_WIDTH = toVw(64);
            var offsetPostion = index == 0 ? 0 : Math.floor(OVERVIEW_WIDTH + (CARD_MARGIN + CARD_WIDTH) * index - CARD_MARGIN);
            var progress = Math.abs(offsetPostion / this.TOTAL_CARD_SELECTOR_WIDTH * 100);
            return progress;
          }
        }, {
          key: "getCaraouselPanProgress",
          value: function getCaraouselPanProgress(deltaX) {
            var progress = Math.abs(deltaX / CARD_MOVEMENT_WIDTH * 100);
            return progress;
          }
        }, {
          key: "swipeLeftHandler",
          value: function swipeLeftHandler($event, index) {
          ...
          key: "swipeRightHandler",
          value: function swipeRightHandler($event, index) {
          ...
          key: "panStartHandler",
          value: function panStartHandler($event, index) {
          ...
          key: "panEndHandler",
          value: function panEndHandler($event, index) {
            var panPercentage = this.calculatePanDistancePercentage($event);
          ...
          key: "calculatePanDistancePercentage",
          value: function calculatePanDistancePercentage($event) {
            var panDelta = $event.deltaX;
            var panPercentage = Math.abs(panDelta) * 100 / CARD_MOVEMENT_WIDTH;
            return panPercentage;
          }
        }, {
          key: "panLeftHandler",
          value: function panLeftHandler($event, index) {
            var panPercentage = this.calculatePanDistancePercentage($event); //console.log("Pan Left", index, this.lastSwipedIndex, $event.deltaX, panPercentage);
            ...
            if (index !== this.selectedCardIndex && index !== this.lastSwipedIndex) {
              if (index > this.selectedCardIndex) {
                if (panPercentage <= 100 && $event.deltaX <= 0) {
                  var progress = this.getCaraouselPanProgress($event.deltaX);
                ...
                if (panPercentage >= 0 && $event.deltaX >= 0) {
                  var _progress = this.getCaraouselPanProgress($event.deltaX);

                  this.seekPreviousAsCurrentCarouselAnimation(index, _progress);
                }
              }
            }
          }
          ...
          key: "panRightHandler",
          value: function panRightHandler($event, index) {
            var panPercentage = this.calculatePanDistancePercentage($event); //console.log("Pan Right", index, this.lastSwipedIndex, $event.deltaX, panPercentage);
            ...
            if (index !== this.selectedCardIndex && index !== this.lastSwipedIndex) {
              if (index > this.selectedCardIndex) {
                ...
                if (panPercentage <= 100 && $event.deltaX >= 0) {
                  var _progress2 = this.getCaraouselPanProgress($event.deltaX);

                  this.seekPreviousAsCurrentCarouselAnimation(index, _progress2);
                } else {
                  this.lastSwipedIndex = index;
                  this.cardSelectorCarouselPreviousAsCurrentAIs[index].play();
                  this.previousAsCurrentCardTimeline.play();
          ...
          key: "swipeUpHandler",
          value: function swipeUpHandler($event) {
            console.log("Swipe Up");
          }
        }, {
          key: "swipeDownHandler",
          value: function swipeDownHandler($event) {
            console.log("Swipe Down");
          }
        }, {
          key: "panUpHandler",
          value: function panUpHandler($event) {
            console.log("Pan Up");
          }
        }, {
          key: "panDownHandler",
          value: function panDownHandler($event) {
          ...
          key: "teardownAnimations",
          value: function teardownAnimations() {
      ...
      _AppComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: "my-app",
    ...
    6747: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ux_account_card_ux_account_card_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ux-account-card/ux-account-card.component */
      882);
      /* harmony import */


      var _ux_account_card_detail_ux_account_card_detail_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./ux-account-card-detail/ux-account-card-detail.component */
      9870);
      ...
      _MyHammerConfig = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)()], _MyHammerConfig);
    ...
    /***/
    9870: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AccountCardDetailComponent": function AccountCardDetailComponent() {
          return (
            /* binding */
            _AccountCardDetailComponent
          );
        }
        /* harmony export */
      ...
      var _C_Users_PATTERNS0004_Downloads_ngx_hide_on_scroll_bdccca_node_modules_ngtools_webpack_src_loaders_direct_resource_js_ux_account_card_detail_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./ux-account-card-detail.component.html */
      5437);
      /* harmony import */


      var _ux_account_card_detail_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ux-account-card-detail.component.scss */
      9948);
      /* harmony import */
      ...
      var _AccountCardDetailComponent = /*#__PURE__*/function () {
        function AccountCardDetailComponent() {
          _classCallCheck(this, AccountCardDetailComponent);
        ...
        _createClass(AccountCardDetailComponent, [{
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {}
        }, {
          key: "ngOnDestroy",
          ...
          key: "swipeLeftHandler",
          value: function swipeLeftHandler($event) {
            this.swipeLeftEventEmitter.emit($event);
          }
        }, {
          key: "swipeRightHandler",
          value: function swipeRightHandler($event) {
          ...
          key: "panLeftHandler",
          value: function panLeftHandler($event) {
            this.panLeftEventEmitter.emit($event);
          }
        }, {
          key: "panRightHandler",
          value: function panRightHandler($event) {
          ...
          key: "formatAmount",
          value: function formatAmount(number) {
        ...
        return AccountCardDetailComponent;
      }();

      _AccountCardDetailComponent.ctorParameters = function () {
        return [];
      };

      _AccountCardDetailComponent.propDecorators = {
        card: [{
        ...
        selectedCardIndex: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input,
          args: ["selectedCardIndex"]
        }],
        swipeLeftEventEmitter: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Output,
          args: ["onswipeleft"]
        }],
        swipeRightEventEventEmitter: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Output,
          args: ["onswiperight"]
        }],
        panLeftEventEmitter: [{
        ...
        panRightEventEmitter: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Output,
          args: ["onpanright"]
        }],
        panStartEventEmitter: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Output,
          args: ["onpanstart"]
        }],
        panEndEventEmitter: [{
      ...
      _AccountCardDetailComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
    ...
    /***/
    882: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AccountCardComponent": function AccountCardComponent() {
          return (
            /* binding */
      ...
      var _C_Users_PATTERNS0004_Downloads_ngx_hide_on_scroll_bdccca_node_modules_ngtools_webpack_src_loaders_direct_resource_js_ux_account_card_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./ux-account-card.component.html */
      5695);
      /* harmony import */


      var _ux_account_card_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./ux-account-card.component.scss */
      38);
      /* harmony import */
      ...
      var _AccountCardComponent = /*#__PURE__*/function () {
      ...
      _AccountCardComponent.ctorParameters = function () {
        return [];
      };

      _AccountCardComponent.propDecorators = {
        card: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Input,
          args: ["card"]
        }],
      ...
      _AccountCardComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
    ...
    4431: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      (0, _angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_3__.platformBrowserDynamic)().bootstrapModule(_app_app_module__WEBPACK_IMPORTED_MODULE_2__.AppModule).then(function (ref) {
    ...
    /***/
    5437: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
